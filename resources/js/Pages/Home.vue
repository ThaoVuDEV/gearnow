...
const slides = ref([
    {
        ...
        title: "BUILD PC CẤU HÌNH KHỦNG",
        subtitle:
            "Tự xây dựng dàn máy trong mơ của bạn với những linh kiện hàng đầu.",
        buttonText: "Build PC Ngay",
    },
    {
        image: "https://cdn.hstatic.net/files/200000637319/article/san-pham-razer_29666dac65f14925ad0273f3961226f1.jpg",
        title: "GAMING GEAR MỚI NHẤT",
        subtitle:
            "Nâng tầm trải nghiệm game với bàn phím, chuột và tai nghe chuyên nghiệp.",
...
const smallBanners = ref([
    {
        image: "https://file.hstatic.net/200000536009/file/02_9d5f55a0ed4e4a5e8494670cf7ae3495.jpg",
        alt: "Sale Màn Hình",
    },
    {
        image: "https://www.phucanh.vn/media/news/0908_900x600gaminggearthih.png",
        alt: "Gear Giá Sốc",
    },
    {
        image: "https://images2.thanhnien.vn/528068263637045248/2024/7/16/image1-17211234370561654046313.png",
        alt: "Laptop Sinh Viên",
    },
    {
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNQSWIqyvd8Ux2pPo8oMD8OUOL3zMxHFyIDQ&s",
...
const flashSaleProducts = ref([
    {
        ...
        image: "https://product.hstatic.net/200000722513/product/large01_c6adf3377eb1458d9b04ad0655dd24ec.jpg",
        oldPrice: "8.990.000đ",
        newPrice: "6.990.000đ",
        sold: 35,
        total: 50,
    },
    {
        ...
        image: "https://bizweb.dktcdn.net/thumb/1024x1024/100/329/122/products/ban-phim-co-razer-blackwidow-v4-pro-rgb-1.jpg?v=1723032011420",
        oldPrice: "4.590.000đ",
        newPrice: "3.790.000đ",
        sold: 15,
        total: 40,
    },
    {
        ...
        image: "https://tanphat.com.vn/media/product/4106_46859_logitech_g_pro_x_superlight_wireless_pink_h2.jpg",
        oldPrice: "3.390.000đ",
        newPrice: "2.890.000đ",
        sold: 68,
        total: 100,
    },
    {
        ...
        image: "https://tanphat.com.vn/media/product/5244_49398_steelseries_arctis_nova_pro_wireless_61520_a5.jpg",
        oldPrice: "7.490.000đ",
        newPrice: "6.490.000đ",
        sold: 8,
        total: 20,
    ...
    {
        id: 5,
        name: "Card màn hình NVIDIA RTX 4070 Ti",
        image: "https://product.hstatic.net/1000288298/product/card-man-hinh-zotac-4070-ti-super-solid7_pcm_6_30ca8c5cab9a459ba8a16e3d325d997a_master.jpg",
        oldPrice: "22.990.000đ",
        newPrice: "20.490.000đ",
        sold: 5,
        total: 10,
    },
    {
        ...
        image: "https://www.tncstore.vn/media/product/250-11524-vo-case-nzxt-h5-flow-rgb-all-black-cc-h52fb-r1--1-.jpg",
        oldPrice: "2.790.000đ",
        newPrice: "2.290.000đ",
        sold: 22,
        total: 40,
        ...
        <div class="max-w-screen-xl mx-auto px-4 mt-4 overflow-hidden">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4" v-scroll-fade-in>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="mt-2 text-lg max-w-lg drop-shadow-md">
                                    {{ slide.subtitle }}
                                </p>
                                <a
                                    href="#"
                                    class="mt-4 inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-transform hover:scale-105"
                                >
                                    {{ slide.buttonText }}
                                </a>
                            </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a
                        ...
                        :key="banner.alt"
                        href="#"
                        class="block rounded-lg shadow-lg overflow-hidden group"
                    >
                        <img
                            :src="banner.image"
                            :alt="banner.alt"
            ...
            >
                    ...
                    <div class="flex items-center justify-between text-white">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                <span
                                    class="bg-white text-red-600 font-bold px-2 py-1 rounded text-lg"
                ...
                <div class="relative p-4">
                    ...
                    <div
                        class="swiper-button-prev absolute top-1/2 -translate-y-1/2 left-0 bg-white/80 p-2 rounded-full shadow-md hover:bg-white transition z-20 cursor-pointer"
                    >
                        <svg
                    ...
                    <div
                        class="swiper-button-next absolute top-1/2 -translate-y-1/2 right-0 bg-white/80 p-2 rounded-full shadow-md hover:bg-white transition z-20 cursor-pointer"
                    >
                        <svg
                            class="w-6 h-6 text-gray-700"
                            fill="none"
            ...
            <section class="mt-8" v-scroll-fade-in>
                ...
                >
                    ...
                    >
                        <div
                            class="w-20 h-20 p-2 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-300"
                        >
                            <img
                                :src="category.image"
                                class="w-full h-full object-contain rounded-full bg-gray-200"
                            />
                        </div>
                        <span
            ...
            >
                ...
                >
                    <div
                        v-for="product in mouseProducts"
                        :key="product.id"
                        class="group relative rounded-lg border-2 border-gray-200 p-3 transition-all duration-300 hover:shadow-xl hover:border-blue-500"
                    >
                        <div
            ...
            <section class="mt-8" v-scroll-fade-in>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div
                        ...
                        :key="testimonial.id"
                        class="bg-white rounded-lg shadow-lg p-6 flex flex-col items-center text-center"
                    >
                        <img
                            :src="testimonial.avatar"
                            class="w-24 h-24 rounded-full mb-4 border-4 border-blue-300"
                        />
                        ...
                        <div
                            ...
                            class="flex text-yellow-400 mt-2"
                        >
            ...
            <section class="mt-8" v-scroll-fade-in>
                ...
                <div
                    class="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 gap-4 bg-white p-6 rounded-lg shadow-lg"
                >
                    <a
                        v-for="brand in brands"
                        :key="brand"
                        href="#"
                        class="flex justify-center items-center p-4 bg-gray-100 rounded-lg transition-transform transform hover:scale-110 hover:shadow-xl"
                    >
                        <img
                            :src="`https://logo.clearbit.com/${brand}.com`"
                            class="h-10 object-contain"
                            :alt="`${brand} Logo`"
                            onerror="this.onerror=null;this.src='https://via.placeholder.com/150x50.png?text='+brand.toUpperCase()"
                        />
                    </a>
                </div>
            </section>

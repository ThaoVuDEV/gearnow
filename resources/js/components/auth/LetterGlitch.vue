<template>
    <div class="relative overflow-hidden">
        ...
        <div
            v-if="outerVignette"
            class="absolute top-0 left-0 w-full h-full pointer-events-none outer-vignette"
        />

        <div
            v-if="centerVignette"
            class="absolute top-0 left-0 w-full h-full pointer-events-none center-vignette"
        />
    </div>
</template>
